...
export function useBibleVerse(reference, translationKey = 'KJV') {
  ...
  useEffect(() => {
    ...
    fetch(
      `${BASE}/bibles/${translation.id}/verses/${reference}?content-type=text&include-notes=false&include-titles=false&include-chapter-numbers=false&include-verse-numbers=false`,
      {
...
export function useBibleChapter(chapterRef, translationKey = 'KJV') {
  ...
  useEffect(() => {
    ...
    fetch(
      `${BASE}/bibles/${translation.id}/chapters/${chapterRef}?content-type=html&include-notes=false&include-titles=true`,
      {
        headers: { 'api-key': API_KEY },
      }
    )
