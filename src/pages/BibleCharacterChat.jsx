...
const CHARACTERS = [
  {
    ...
    bg: '#FFFBEB',
    intro:
      "Shalom! I am David, son of Jesse, shepherd of Bethlehem and king of Israel. I have known God's protection from my youth — from the fields to the palace, through triumph and heartbreak. What would you ask of me?",
  ...
  },
  {
    ...
    bg: '#F5F3FF',
    intro:
      "I am Moses, servant of the LORD. I was raised in Pharaoh's palace yet called by God from a burning bush to deliver my people from slavery. I have stood before the Almighty on holy ground. Ask what is on your heart.",
  ...
  },
  {
    ...
    bg: '#EFF6FF',
    intro:
      'Grace and peace to you! I am Paul, formerly Saul of Tarsus — a Pharisee who persecuted the church until Christ appeared to me on the Damascus road and changed everything. I have traveled the world for the Gospel. What question burns in your heart?',
  ...
  },
  {
    ...
    bg: '#FDF2F8',
    intro:
      "Shalom. I am Esther, daughter of Abihail, raised by my cousin Mordecai in Persia. God placed me in the palace for a reason that was revealed in the most frightening moment of my life. 'For such a time as this.' What would you like to know?",
  ...
  },
  {
    ...
    bg: '#F0FDFA',
    intro:
      'Peace be with you. I am Mary, a servant girl from Nazareth. When the angel Gabriel appeared to me, I could not have imagined what God would do through my obedience. But I have treasured every moment in my heart. What would you ask?',
  ...
  },
  {
    ...
    bg: '#ECFDF5',
    intro:
      'Greetings, friend. I am Noah. In a world that had turned from its Creator, God found me walking in righteousness — and gave me a task that seemed impossible. I built an ark. I trusted. And He was faithful beyond imagination.',
  ...
  },
  {
    ...
    bg: '#FFF7ED',
    intro:
      "Shalom, friend. I am Ruth, a Moabite woman who became part of God's people. I came to a foreign land with nothing but my loyalty to Naomi and my faith in the God of Israel. Through faithfulness and hard work, God blessed me beyond measure. What would you ask?",
...
export default function BibleCharacterChat() {
  ...
  async function sendMessage() {
    ...
    try {
      ...
      if (text) {
        ...
        setMessages((prev) => [
          ...prev,
          { role: 'assistant', text: `I cannot speak at this moment. Please try again later.` },
        ]);
      }
    } catch {
      setMessages((prev) => [
        ...prev,
        { role: 'assistant', text: 'Connection failed. Please try again later.' },
      ]);
    }
    setLoading(false);
  }
  ...
  const QUICK_QUESTIONS = {
    david: [
      'What was it like to fight Goliath?',
      'How did you write the Psalms?',
      'What was your biggest mistake?',
      'What advice do you have for young people?',
    ],
    moses: [
      'What happened at the burning bush?',
      'How did the Red Sea part?',
      'What was it like to receive the Ten Commandments?',
      "Why couldn't you enter the Promised Land?",
    ],
    paul: [
      'What happened on the road to Damascus?',
      'What is the meaning of faith?',
      'How did you endure imprisonment?',
      "What did you mean by 'I can do all things'?",
    ],
    esther: [
      'Were you afraid to approach the king?',
      "What was Mordecai's role?",
      'How did you fast before your moment?',
      "What does 'for such a time as this' mean?",
    ],
    mary: [
      'What did the angel say to you?',
      'What was the night Jesus was born like?',
      'How did you feel at the cross?',
      'What was Jesus like as a child?',
    ],
    noah: [
      'How long did you build the ark?',
      'Did people mock you?',
      'What was it like on the ark for 40 days?',
      'What did the rainbow mean to you?',
    ],
  };
      ...
      >
        ...
        <h1
          style={{
            ...
            fontWeight: 800,
            background: 'linear-gradient(90deg,#A5B4FC,#F9A8D4,#FCD34D)',
        ...
        >
          Ask Moses about the Red Sea. Ask David about Goliath. Ask Paul about faith. Have a real
          conversation with the heroes of scripture.
        </p>
      </div>
          ...
          <div>
            <div style={{ textAlign: 'center', marginBottom: 28 }}>
              ...
              <p style={{ fontSize: '.87rem', color: 'var(--ink3)', fontWeight: 500 }}>
                Each character responds based on their real biblical story
              </p>
            </div>
              ...
              {CHARACTERS.map((c) => (
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = `0 16px 48px ${c.color}30`;
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  <div style={{ fontSize: '.75rem', color: 'var(--ink2)', fontWeight: 500 }}>
                    {c.role}
                  </div>
                  <div
                    style={{
          ...
          <div>
            ...
            >
              ...
              <div style={{ display: 'flex', align: 'center', gap: 10 }}>
                <div style={{ fontSize: '.72rem', fontWeight: 600, color: 'var(--ink3)' }}>
                  {askCount} questions asked
                </div>
                <button className="btn btn-outline btn-sm" onClick={() => setSelectedChar(null)}>
                  ← Characters
                </button>
              </div>
            </div>
                ...
                >
                  <div
                    style={{
                      ...
                      height: 34,
                      borderRadius: '50%',
                      background: msg.role === 'assistant' ? selectedChar.bg : 'var(--blue-bg)',
                      border: `1.5px solid ${msg.role === 'assistant' ? selectedChar.color : 'var(--blue)'}`,
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      fontSize: '1.1rem',
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: '50%',
                      background: selectedChar.bg,
                      border: `1.5px solid ${selectedChar.color}`,
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      fontSize: '1.1rem',
              ...
              {(QUICK_QUESTIONS[selectedChar.id] || []).map((q, i) => (
                <button
                  ...
                  style={{
                    ...
                    padding: '5px 12px',
                    borderRadius: 100,
                    border: `1.5px solid ${selectedChar.color}33`,
                    background: selectedChar.bg,
            ...
            >
              ...
              <div style={{ display: 'flex', gap: 9, alignItems: 'center' }}>
                <span style={{ fontSize: '.72rem', color: 'var(--ink3)', fontWeight: 600 }}>
                  ✨ Character wisdom powered by AI. No sign-in required.
                </span>
              </div>
            </div>
          </div>
