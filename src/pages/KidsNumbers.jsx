...
const BIBLE_NUMBERS = [
  {
    ...
    desc: 'There is only one God who loves us',
    emoji: '☝️',
    color: '#FCD34D',
  },
  {
    ...
    desc: 'God gave Moses 2 tablets with His laws',
    emoji: '📜',
    color: '#60A5FA',
  },
  {
    ...
    title: 'Three Days',
    verse: 'Matthew 12:40',
    desc: 'Jesus rose on the third day',
    emoji: '⛪',
    color: '#F472B6',
  },
  {
    num: 4,
    title: 'Four Gospels',
    verse: 'Matthew, Mark, Luke, John',
    desc: "Four books tell Jesus' story",
    emoji: '📖',
    color: '#34D399',
  },
  {
    ...
    title: 'Five Loaves',
    verse: 'Matthew 14:17',
    desc: 'Jesus fed 5,000 with 5 loaves',
    emoji: '🍞',
    color: '#FB923C',
  },
  {
    ...
    verse: 'Exodus 20',
    desc: 'God gave us 10 rules to follow',
    emoji: '⚡',
    color: '#8B5CF6',
  },
  {
    ...
    desc: 'Jesus chose 12 special helpers',
    emoji: '👥',
    color: '#EC4899',
  },
  {
    ...
    title: 'Forty Days',
    verse: 'Matthew 4:2',
    desc: 'Jesus fasted for 40 days in the desert',
    emoji: '🏜️',
    color: '#10B981',
  },
];
      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ fontSize: '.95rem', color: 'var(--ink3)', maxWidth: 500, margin: '0 auto' }}>
            Learn special numbers from the Bible and what they mean!
          </p>
        </div>
        ...
        >
          {BIBLE_NUMBERS.map((item, i) => (
            ...
            >
              ...
              <div style={{ fontSize: '.75rem', fontWeight: 700, color: 'var(--ink2)' }}>
                {item.title}
              </div>
            </button>
          ))}
