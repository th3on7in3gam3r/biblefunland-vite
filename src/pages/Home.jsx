...
const COMMUNITY = [
  { icon: '🙏', title: 'Prayer Wall', desc: 'Realtime community prayer with Supabase live sync', to: '/prayer', color: '#10B981' },
      ...
      <section style={{ position: 'relative', minHeight: '92vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', padding: '80px 24px 60px', textAlign: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 760 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, fontSize: '.72rem', fontWeight: 800, letterSpacing: 1, textTransform: 'uppercase', background: 'rgba(99,102,241,.18)', color: '#A5B4FC', border: '1px solid rgba(99,102,241,.25)', padding: '6px 18px', borderRadius: 100, marginBottom: 28, animation: 'fadeDown .6s ease both' }}>
            ...
            30+ Features · AI-Powered · 100% Free · Always Growing
          </div>
          ...
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 48, animation: 'fadeUp .7s .3s ease both' }}>
            <Link to="/trivia" className="btn btn-lg" style={{ background: 'linear-gradient(135deg,#3B82F6,#8B5CF6)', color: 'white', border: 'none', boxShadow: '0 8px 30px rgba(99,102,241,.4)', fontWeight: 800, letterSpacing: .3 }}>
              🎮 Play Bible Trivia
            </Link>
            <Link to="/quiz/character" className="btn btn-lg" style={{ background: 'rgba(255,255,255,.08)', color: 'white', border: '1.5px solid rgba(255,255,255,.15)', backdropFilter: 'blur(8px)', fontWeight: 700 }}>
              🧬 What Character Are You?
            </Link>
            <Link to="/ai/rap-generator" className="btn btn-lg" style={{ background: 'rgba(168,85,247,.15)', color: '#C084FC', border: '1.5px solid rgba(168,85,247,.25)', fontWeight: 700 }}>
              🎵 Bible Rap Generator
            </Link>
          </div>
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap', animation: 'fadeUp .7s .4s ease both' }}>
            {['🌍 Global Prayer Map','📿 Prayer Beads','🏃 Scripture Runner','🎰 Spin the Verse','🧩 Escape Room','🎓 Certification'].map((pill, i) => (
              <span key={i} style={{ fontSize: '.7rem', fontWeight: 700, padding: '5px 12px', borderRadius: 100, background: 'rgba(255,255,255,.06)', color: 'rgba(255,255,255,.5)', border: '1px solid rgba(255,255,255,.1)' }}>
                {pill}
              </span>
            ))}
          </div>
