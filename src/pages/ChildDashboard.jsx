    ...
    return (
      ...
      >
        <div style={{ textAlign: 'center', maxWidth: 400 }}>
          ...
          <p style={{ fontSize: '.9rem', color: 'var(--ink3)', fontWeight: 500, marginBottom: 24 }}>
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', fontFamily: 'Poppins,sans-serif' }}>
      ...
      {familyWinBanner && (
        ...
        >
          ...
          <div style={{ fontSize: '.82rem', color: 'rgba(255,255,255,.9)', fontWeight: 500 }}>
            All children completed today's devotional. Celebrate together! 🙏
          </div>
        </div>
      )}
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '.75rem', color: 'rgba(255,255,255,.9)', fontWeight: 500 }}>
                {child.display_name} hasn't completed devotional for 3+ days
              </div>
            </div>
          </div>
        </div>
      ...
      <div style={{ maxWidth: 820, margin: '0 auto', padding: 'clamp(20px,5vw,32px) 16px' }}>
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: 54,
                          borderRadius: '50%',
                          background: earned ? `${s.color}22` : 'var(--bg2)',
                          border: earned ? `2px solid ${s.color}` : '2px dashed var(--border)',
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                          fontSize: '1.8rem',
        ...
        {/* ─ PROGRESS ────────────────────────────────────────────────────────── */}
        {tab === 'progress' && <ProgressReport childId={childId} childName={child.display_name} />}
