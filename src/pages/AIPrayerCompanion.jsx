  ...
  async function send(text) {
    ...
    try {
      ...
      if (text) {
        ...
        setMessages([
          ...newMessages,
          {
            role: 'assistant',
            content:
              "I'm sorry — I couldn't connect with Heaven's gates right now. Please try again in a moment.",
          },
        ]);
        setPhase('conversation');
      }
      ...
      setMessages([
        ...
        {
          role: 'assistant',
          content: 'Connection failed. Please check your internet and try again later.',
        },
      ]);
    }
    setLoading(false);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Share what's on your heart. Your companion will pray with you, offer scripture, and walk
          alongside you.
        </p>
      </div>
          ...
          <div style={{ textAlign: 'center', paddingTop: 20 }}>
            <div
              style={{
                fontSize: '4rem',
                marginBottom: 16,
                filter: 'drop-shadow(0 0 20px rgba(110,231,183,.3))',
              }}
            >
              🕊️
            </div>
            ...
            >
              This is a safe, private space. Share freely. Nothing is stored. Your companion will
              pray with you and offer God's Word for your situation.
            </p>
            {/* Starter prompts */}
            <div
              style={{
              ...
              {[0, 1, 2].map((i) => (
                <div
                  ...
                  style={{
                    ...
                    animation: `dotBounce .8s ${i * 0.15}s ease-in-out infinite`,
                  }}
                />
              ))}
              <span
                style={{ marginLeft: 8, fontSize: '.76rem', color: 'var(--ink3)', fontWeight: 500 }}
              >
        ...
        <div style={{ maxWidth: 720, margin: '0 auto', display: 'flex', gap: 10 }}>
          ...
          <button
            ...
            style={{
              ...
              border: 'none',
              background:
                input.trim() && !loading ? 'linear-gradient(135deg,#064E3B,#0F9D58)' : 'var(--bg3)',
              color: input.trim() && !loading ? 'white' : 'var(--ink3)',
              cursor: input.trim() && !loading ? 'pointer' : 'default',
              fontSize: '1.1rem',
              flexShrink: 0,
              transition: 'all .2s',
              boxShadow: input.trim() && !loading ? '0 4px 14px rgba(6,78,59,.35)' : 'none',
            }}
          >
            🕊️
          </button>
