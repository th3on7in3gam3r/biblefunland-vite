...
const MOODS = [
  ...
  },
  {
    ...
    icon: '🕊️',
    color: '#14B8A6',
    desc: 'Peace that passes understanding',
  ...
  },
  {
    ...
    icon: '⭐',
    color: '#FCD34D',
    desc: 'Emmanuel, God with us',
    bg: 'rgba(252,211,77,.1)',
  },
  {
    id: 'morning',
    ...
    icon: '🌅',
    color: '#F97316',
    desc: 'New mercies every morning',
  ...
  },
  {
    ...
    icon: '🌙',
    color: '#6366F1',
    desc: 'He grants sleep to those He loves',
    bg: 'rgba(99,102,241,.1)',
  },
];
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', fontFamily: 'Poppins,sans-serif' }}>
      ...
      >
        ...
        <p style={{ color: 'rgba(255,255,255,.45)', fontSize: '.88rem', fontWeight: 500 }}>
          Curated Christian playlists for every season of the soul. Pick your mood — let worship
          find you.
        </p>
      </div>
          ...
          >
            {MOODS.map((m) => (
              <div
                ...
                style={{
                  background: mood?.id === m.id ? m.bg : 'var(--surface)',
                  borderRadius: 18,
                  border: `1.5px solid ${mood?.id === m.id ? m.color : 'var(--border)'}`,
                  padding: '16px 14px',
                  cursor: 'pointer',
                  transition: 'all .22s',
                  textAlign: 'center',
                  boxShadow: mood?.id === m.id ? `0 6px 20px ${m.color}20` : 'none',
                  transform: mood?.id === m.id ? 'scale(1.03)' : 'scale(1)',
                }}
              >
                ...
                <div
                  style={{
                    fontFamily: "'Baloo 2',cursive",
                    fontWeight: 800,
                    color: mood?.id === m.id ? m.color : 'var(--ink)',
                    fontSize: '.82rem',
                    lineHeight: 1.2,
                    marginBottom: 3,
                  }}
                ...
                <div style={{ fontSize: '.62rem', color: 'var(--ink3)', fontWeight: 500 }}>
                  {m.desc}
                </div>
              </div>
            ))}
          ...
          <div style={{ animation: 'fadeIn .35s ease' }}>
            <div
              style={{
                ...
                borderRadius: 24,
                border: `1.5px solid ${currentMood.color}44`,
                overflow: 'hidden',
              }}
            >
              <div
                style={{
                  background: `linear-gradient(135deg,${currentMood.color}18,${currentMood.color}06)`,
                  padding: '22px 26px',
                ...
                {playlist.songs.map((song, i) => (
                  <div
                    ...
                    style={{
                      ...
                      padding: '14px 24px',
                      borderBottom:
                        i < playlist.songs.length - 1 ? '1px solid var(--border)' : 'none',
                    }}
                  >
                    <div
                      style={{
            ...
            >
              🎵 Opens YouTube search results for curated {currentMood.label.toLowerCase()} worship
              music
            </p>
          </div>
        )}
