...
const SAMPLE = [
  {
    ...
    category: 'Family',
    verse: 'Jer 17:14',
    verseText: 'Heal me, Lord, and I will be healed; save me and I will be saved.',
    text: "Lord, please heal my mom. She's been fighting this for months. I trust you.",
    answered: false,
    answeredNote: '',
    date: '2026-02-14',
    tags: ['healing', 'family'],
  },
  {
    ...
    text: "God I need provision. I've sent 20 applications. I trust your timing.",
    answered: true,
    answeredNote: 'Got the call on March 3rd. He provided exactly what I needed.',
    date: '2026-01-08',
    tags: ['provision', 'work'],
  },
];
...
export default function PrayerJournal() {
  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh', fontFamily: 'Poppins,sans-serif' }}>
      ...
      <div
        style={{
          background: 'linear-gradient(135deg,#0A1A0F,#064E3B,#0F172A)',
      ...
      >
        ...
        <p style={{ color: 'rgba(255,255,255,.45)', fontSize: '.88rem', fontWeight: 500 }}>
          Your private space with God. Log prayers, link scripture, mark answered.
        </p>
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  padding: '7px 13px',
                  borderRadius: 10,
                  border: `1.5px solid ${view === v ? 'var(--green)' : 'var(--border)'}`,
                  background: view === v ? 'var(--green-bg)' : 'var(--surface)',
                  color: view === v ? 'var(--green)' : 'var(--ink3)',
                  cursor: 'pointer',
                }}
              >
                {l}
            ...
            return (
              <button
                ...
                style={{
                  ...
                  borderRadius: 100,
                  cursor: 'pointer',
                  border: `1.5px solid ${filter === c ? color : 'var(--border)'}`,
                  background: filter === c ? color + '18' : 'var(--surface)',
                  color: filter === c ? color : 'var(--ink3)',
                  transition: 'all .2s',
                }}
              >
                {c}
        ...
        {showForm && (
          ...
          >
            ...
            >
              <input
                className="input-field"
                placeholder="Verse ref (e.g. Phil 4:6)"
                value={form.verse}
            ...
            <input
              className="input-field"
              placeholder="Tags (comma separated): healing, family, work..."
              value={form.tags}
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              >
                {editId ? 'Save Changes' : '🙏 Log Prayer'}
              </button>
              <button
        ...
        {answering && (
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: '.86rem', color: 'var(--ink3)', marginBottom: 16 }}>
                How did God answer this prayer? (Optional but encouraged — your future self will
                treasure this.)
              </p>
              <textarea
                className="textarea-field"
                placeholder="Write how God answered..."
                value={answerNote}
                onChange={(e) => setAnswerNote(e.target.value)}
                style={{ height: 80, marginBottom: 14 }}
              />
              <div style={{ display: 'flex', gap: 10 }}>
                <button className="btn btn-green" onClick={() => markAnswered(answering)}>
                  ✅ Mark Answered
                </button>
                <button className="btn btn-outline" onClick={() => setAnswering(null)}>
                  Cancel
                </button>
              </div>
            </div>
              ...
              return (
                <div
                  ...
                  style={{
                    background: 'var(--surface)',
                    borderRadius: 18,
                    border: `1.5px solid ${entry.answered ? 'rgba(16,185,129,.3)' : 'var(--border)'}`,
                    overflow: 'hidden',
                    transition: 'all .2s',
                  }}
                >
                  ...
                  <div style={{ padding: '18px 20px' }}>
                    ...
                    {isExpanded && entry.answered && entry.answeredNote && (
                      ...
                      >
                        ...
                        >
                          ✅ How God answered — {entry.answeredDate}
                        </div>
                        <p
                          style={{
                            fontSize: '.84rem',
                    ...
                    {isExpanded && (
                      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                        ...
                        <button className="btn btn-outline btn-sm" onClick={() => startEdit(entry)}>
                          ✏️ Edit
                        </button>
                        <button
