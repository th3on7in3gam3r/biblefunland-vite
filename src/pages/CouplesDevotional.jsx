...
export default function CouplesDevotional() {
  ...
  async function generate(t) {
    ...
    if (!subject.trim()) {
      setError('Choose or type a topic first.');
      return;
    }
    setError('');
    setLoading(true);
  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh', fontFamily: 'Poppins,sans-serif' }}>
      <div
        style={{
          background: 'linear-gradient(135deg,#1A0010,#0F0F1A,#1A0010)',
      ...
      >
        ...
        <h1
          style={{
            ...
            fontWeight: 800,
            background: 'linear-gradient(90deg,#F9A8D4,#FCD34D,#F9A8D4)',
        ...
        >
          A devotional built for two. His reflection. Her reflection. A conversation. A prayer.
          Together.
        </p>
      </div>
        ...
        >
            ...
            {TOPICS.map((t) => (
              <button
                ...
                style={{
                  ...
                  padding: '7px 13px',
                  borderRadius: 100,
                  border: `1.5px solid ${topic === t ? 'var(--pink)' : 'var(--border)'}`,
                  background: topic === t ? 'var(--pink-bg)' : 'var(--surface)',
                  color: topic === t ? 'var(--pink)' : 'var(--ink2)',
                  cursor: 'pointer',
                  transition: 'all .2s',
                }}
              >
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            <input
              ...
              placeholder='Or type your own: "Dealing with in-laws", "When we disagree about money"...'
              value={custom}
              onChange={(e) => {
          ...
          >
            <span style={{ fontSize: '.7rem', color: 'var(--ink3)', fontWeight: 600 }}>
              ✨ Powered by secure AI proxy. Premium generation active.
            </span>
          </div>
          {error && (
            <div
        ...
        {loading && (
          <div style={{ textAlign: 'center', padding: '48px 0' }}>
            ...
            <p style={{ color: 'var(--ink2)', fontWeight: 600 }}>
              Writing your devotional for two...
            </p>
          </div>
        )}
