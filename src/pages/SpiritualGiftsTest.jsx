    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            "Now concerning spiritual gifts, brothers, I do not want you to be uninformed." (1 Cor
            12:1). Take this free, 21-question assessment to uncover how God has uniquely equipped
            you to serve the church and the world.
          </p>
          <button
            onClick={startTest}
            className="btn"
  ...
  if (view === 'loading') {
    return (
      ...
      >
        ...
        <h2 style={{ fontFamily: "'Baloo 2', cursive", fontSize: '1.8rem', color: 'var(--ink)' }}>
      ...
      >
        ...
        >
          <div style={{ maxWidth: 600, margin: '0 auto' }}>
            ...
            <div
              style={{ height: 6, borderRadius: 10, background: 'var(--bg3)', overflow: 'hidden' }}
            >
              <div
                style={{
                  height: '100%',
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      onMouseEnter={(e) =>
                        !isSelected && (e.currentTarget.style.background = `${opt.color}22`)
                      }
                      onMouseLeave={(e) =>
                    ...
                    <span
                      style={{
                        ...
                        color: isSelected ? 'var(--ink)' : 'var(--ink3)',
  ...
  if (view === 'results' && results) {
    ...
    return (
      ...
      >
        ...
        <div
          style={{
            background: `linear-gradient(135deg, ${topGift.color}15, ${topGift.color}05)`,
            padding: '60px 20px',
            borderBottom: '1px solid var(--border)',
            textAlign: 'center',
          }}
        >
          ...
          <div
            style={{
              fontSize: '5rem',
              marginBottom: 10,
              filter: `drop-shadow(0 10px 20px ${topGift.color}40)`,
            }}
          >
            {topGift.icon}
          </div>
          ...
          >
            <button onClick={startTest} className="btn btn-outline" style={{ borderRadius: 100 }}>
              Retake Assessment
            </button>
            {!user && (
              <Link to="/auth" className="btn btn-blue" style={{ borderRadius: 100 }}>
            ...
            <button
              onClick={() =>
                navigator.clipboard.writeText(
                  `I just took the BibleFunLand Spiritual Gifts test and got '${topGift.name}'! Take it here: ${window.location.href}`
                )
              }
        ...
        >
          ...
          >
                    ...
                    >
                      <div
                        style={{
                          height: '100%',
                          width: `${r.percent}%`,
                          background: isTop ? g.color : 'var(--ink3)',
                          borderRadius: 10,
                        }}
                      />
                    </div>
            ...
            >
              *Scores are based out of 100%. Most people possess a blend of 2-3 primary gifts that
              ...
              <div key={g.id} style={{ borderLeft: `4px solid ${g.color}`, paddingLeft: 24 }}>
                ...
                >
                  {g.actionSteps.map((s, idx) => (
                    <li key={idx}>
                      <span style={{ color: 'var(--ink2)' }}>{s}</span>
                    </li>
                  ))}
                </ul>
