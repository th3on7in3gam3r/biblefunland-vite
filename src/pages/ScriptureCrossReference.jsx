...
const NODES = [
  ...
  },
  {
    id: 'ROM.5.8',
    label: 'Rom 5:8',
    text: 'While we were still sinners...',
    category: 'Epistle',
    color: '#8B5CF6',
  },
  {
    id: '1JHN.4.9',
    label: '1 John 4:9',
    text: 'He sent his one and only Son...',
    category: 'Epistle',
    color: '#8B5CF6',
  },
  {
  ...
  },
  {
    id: 'PSA.22.1',
    label: 'Ps 22:1',
    text: 'My God, why have you forsaken me...',
    category: 'Psalm',
    color: '#3B82F6',
  },
  {
  ...
  },
  {
    id: 'MIC.5.2',
    label: 'Mic 5:2',
    text: 'Out of Bethlehem will come a ruler...',
    category: 'Prophecy',
    color: '#F59E0B',
  },
  {
    id: 'LUK.2.11',
    label: 'Luke 2:11',
    text: 'A Savior has been born to you...',
    category: 'Gospel',
    color: '#EC4899',
  },
  {
  ...
  },
  {
    id: 'HAB.2.4',
    label: 'Hab 2:4',
    text: 'The righteous will live by his faithfulness',
    category: 'Prophecy',
    color: '#F59E0B',
  },
  {
...
export default function ScriptureCrossReference() {
  ...
  function onMouseMove(e) {
    ...
    setPositions((p) => ({
      ...p,
      [dragging]: { x: Math.max(40, Math.min(W - 40, x)), y: Math.max(30, Math.min(H - 30, y)) },
    }));
  }
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', fontFamily: 'Poppins,sans-serif' }}>
      ...
      <div style={{ maxWidth: 1060, margin: '0 auto', padding: '24px 20px' }}>
          ...
          {['All', 'Gospel', 'Prophecy', 'Epistle', 'Psalm', 'History'].map((f) => (
            <button
              ...
              style={{
                ...
                borderRadius: 100,
                cursor: 'pointer',
                border: `1.5px solid ${filter === f ? CATEGORY_COLORS[f] || 'var(--blue)' : 'var(--border)'}`,
                background:
                  filter === f ? (CATEGORY_COLORS[f] || 'var(--blue)') + '18' : 'var(--surface)',
                color: filter === f ? CATEGORY_COLORS[f] || 'var(--blue)' : 'var(--ink3)',
                transition: 'all .2s',
              }}
            >
              {f}
        ...
        <div
          style={{
            display: 'grid',
            gridTemplateColumns: '1fr clamp(220px,28%,280px)',
            gap: 16,
            alignItems: 'start',
          }}
        >
          ...
          >
            <svg
              ref={svgRef}
              viewBox={`0 0 ${W} ${H}`}
              style={{ width: '100%', cursor: dragging ? 'grabbing' : 'default', display: 'block' }}
                ...
                return (
                  ...
                  >
                    ...
                    <circle
                      ...
                      style={{
                        filter: isSelected ? `drop-shadow(0 0 12px ${node.color})` : 'none',
                        transition: 'all .2s',
                      }}
                    />
                    <text
            ...
            {selectedNode ? (
              <div
                style={{
                  background: 'var(--surface)',
                  borderRadius: 20,
                  border: `1.5px solid ${selectedNode.color}44`,
                  overflow: 'hidden',
                }}
              >
                <div
                  style={{
                    background: `linear-gradient(135deg,${selectedNode.color}22,${selectedNode.color}08)`,
                ...
                <div style={{ padding: '16px 20px' }}>
                  ...
                  >
                    Connected to {connectedEdges.length} verse
                    ...
                    return other ? (
                      ...
                      >
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{ fontSize: '.62rem', color: edgeColor, fontWeight: 700 }}>
                            {isOutgoing ? '→' : '←'} {e.label}
                          </div>
                        </div>
                      </div>
              ...
              >
                ...
                >
                  Click any verse node to see how it connects to the rest of Scripture. Drag nodes
                  to rearrange.
                </div>
                {/* Legend */}
                <div style={{ marginTop: 20, textAlign: 'left' }}>
                  ...
                  {Object.entries(CATEGORY_COLORS).map(([cat, color]) => (
                    ...
                    >
                      ...
                      />
                      <span style={{ fontSize: '.74rem', fontWeight: 600, color: 'var(--ink2)' }}>
                        {cat}
                      </span>
                    </div>
                  ))}
