...
const PROPHECIES = [
  {
    ...
    fulfillment: {
      ref: 'Luke 2:4-7',
      text: 'Joseph also went up from Galilee, out of the city of Nazareth, into Judea, to the city of David, which is called Bethlehem… and she brought forth her firstborn Son.',
    },
    gap: '~700 years',
  ...
  },
  {
    ...
    fulfillment: {
      ref: 'Matthew 1:22-23',
      text: 'All this took place to fulfill what the Lord had said through the prophet: "The virgin will conceive and give birth to a son."',
    },
    gap: '~700 years',
  ...
  },
  {
    ...
    fulfillment: {
      ref: 'Matthew 2:14-15',
      text: 'So he got up, took the child and his mother during the night and left for Egypt, where he stayed until the death of Herod.',
    },
    gap: '~750 years',
  ...
  },
  {
    ...
    prophecy: {
      ref: 'Zechariah 9:9',
      text: 'Rejoice greatly, Daughter Zion! Shout, Daughter Jerusalem! See, your king comes to you, righteous and victorious, lowly and riding on a donkey.',
      date: '~520 BC',
    },
    fulfillment: {
      ref: 'John 12:13-15',
      text: 'They took palm branches and went out to meet him, shouting, "Hosanna!" Blessed is he who comes in the name of the Lord! Blessed is the king of Israel!"',
    },
    gap: '~520 years',
  ...
  },
  {
    ...
    prophecy: {
      ...
      text: 'So they paid me thirty pieces of silver. And the Lord said to me, "Throw it to the potter" — the handsome price at which they valued me! So I took the thirty pieces of silver and threw them to the potter at the house of the Lord.',
      date: '~520 BC',
    },
    fulfillment: {
      ref: 'Matthew 26:15, 27:5-7',
      text: "They counted out for him thirty pieces of silver… Judas threw the money into the temple and left. The chief priests… decided to use the money to buy the potter's field.",
    },
    gap: '~520 years',
  ...
  },
  {
    ...
    prophecy: {
      ref: 'Isaiah 53:7',
      text: 'He was oppressed and afflicted, yet he did not open his mouth; he was led like a lamb to the slaughter, and as a sheep before its shearers is silent, so he did not open his mouth.',
      date: '~700 BC',
    },
    fulfillment: {
      ref: 'Matthew 27:12-14',
      text: 'When he was accused by the chief priests and the elders, he gave no answer. Then Pilate asked him, "Don\'t you hear the testimony they are bringing against you?" But Jesus made no reply, not even to a single charge.',
    },
    gap: '~700 years',
  ...
  },
  {
    ...
    prophecy: {
      ref: 'Psalm 22:16',
      text: 'Dogs surround me, a pack of villains encircles me; they pierce my hands and my feet.',
      date: '~1000 BC',
    },
    fulfillment: {
      ref: 'John 20:25-27',
      text: 'Unless I see the nail marks in his hands and put my finger where the nails were… Jesus said, "Put your finger here; see my hands."',
    },
    gap: '~1000 years',
  ...
  },
  {
    ...
    fulfillment: {
      ref: 'John 19:23-24',
      text: '"Let\'s not tear it," they said to one another. "Let\'s decide by lot who will get it."… So this is what the soldiers did.',
    },
    gap: '~1000 years',
  ...
  },
  {
    ...
    fulfillment: {
      ref: 'John 19:33-36',
      text: 'But when they came to Jesus and found that he was already dead, they did not break his legs… These things happened so that the scripture would be fulfilled: "Not one of his bones will be broken."',
    },
    gap: '~1000 years',
  ...
  },
  {
    ...
    fulfillment: {
      ref: 'Acts 2:31-32',
      text: 'Seeing what was to come, he spoke of the resurrection of the Messiah, that he was not abandoned to the realm of the dead, nor did his body see decay. God has raised this Jesus to life.',
    },
    gap: '~1000 years',
  ...
  },
  {
    ...
    fulfillment: {
      ref: 'Acts 7:55-56',
      text: 'Stephen, full of the Holy Spirit, looked up to heaven and saw the glory of God, and Jesus standing at the right hand of God.',
    },
    gap: '~1000 years',
  ...
  },
  {
    ...
    fulfillment: {
      ...
      text: '"For all the Prophets and the Law prophesied until John. And if you are willing to accept it, he is the Elijah who was to come."',
    },
    gap: '~430 years',
...
const CAT_COLORS = {
  'Birth & Early Life': '#F59E0B',
  Ministry: '#8B5CF6',
  'Passion & Death': '#EF4444',
  'Resurrection & Glory': '#10B981',
  Forerunner: '#3B82F6',
};
...
export default function ProphecyFulfillment() {
  ...
  const filtered =
    category === 'All' ? PROPHECIES : PROPHECIES.filter((p) => p.category === category);
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', fontFamily: 'Poppins,sans-serif' }}>
      ...
      >
        ...
        <h1
          style={{
            ...
            fontWeight: 800,
            background: 'linear-gradient(90deg,#FCD34D,#F97316,#EC4899)',
        ...
        >
          Old Testament prophecies written centuries before Christ — fulfilled with mathematical
          precision. The case for the Messiah.
        </p>
        <button
        ...
        {showStats && (
          ...
          >
            ...
            >
              Mathematician Peter Stoner calculated that the probability of ONE person fulfilling
              just 8 of these prophecies by chance is 1 in 10<sup>17</sup> — that's 1 in
            ...
            >
              Illustration: Fill the state of Texas 2 feet deep with silver dollars. Mark one.
              Blindfold a person and ask them to pick the marked coin on the first try. That's the
              probability. And Stoner examined 48 prophecies, not 8.
            </p>
          </div>
        )}
      </div>
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '28px 20px' }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  borderRadius: 100,
                  cursor: 'pointer',
                  border: `1.5px solid ${category === c ? color : 'var(--border)'}`,
                  background: category === c ? color + '18' : 'var(--surface)',
                  color: category === c ? color : 'var(--ink3)',
                  transition: 'all .2s',
                }}
              >
                {c}
        ...
        <div
          style={{
            display: 'grid',
            gridTemplateColumns: detail ? '1fr 1.3fr' : '1fr',
            gap: 16,
            alignItems: 'start',
          }}
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {filtered.map((p) => (
              <div
                ...
                style={{
                  borderRadius: 16,
                  border: `1.5px solid ${selected === p.id ? p.color : 'var(--border)'}`,
                  padding: '16px 18px',
                  cursor: 'pointer',
                  transition: 'all .22s',
                  background: selected === p.id ? p.color + '10' : 'var(--surface)',
                }}
              >
                <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      <span
                        style={{
                          fontFamily: "'Baloo 2',cursive",
                          fontWeight: 800,
                          color: selected === p.id ? p.color : 'var(--ink)',
                          fontSize: '.9rem',
                        }}
                      >
                        {p.prophecy.ref}
                    ...
                    <div style={{ fontSize: '.78rem', color: 'var(--ink3)', fontWeight: 500 }}>
                      Fulfilled in →{' '}
                      <strong style={{ color: selected === p.id ? p.color : 'var(--ink2)' }}>
                        {p.fulfillment.ref}
                      </strong>
                    </div>
                    <div
          ...
          {detail && (
            ...
            >
              <div
                style={{
                  background: `linear-gradient(135deg,${detail.color}22,${detail.color}06)`,
                  padding: '24px 28px',
              ...
              >
                <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 10 }}>
                  ...
                  {detail.probability !== 'Pattern fulfillment' && (
                    <span
                      style={{
                        fontSize: '.66rem',
                        fontWeight: 700,
                ...
                >
                  {detail.prophecy.ref} · Written {detail.prophecy.date}
                </div>
                <p
                  style={{
                    fontSize: '.9rem',
