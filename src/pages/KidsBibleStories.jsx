...
const AGES = [
  { value: '4', label: 'Ages 3–5', desc: 'Very simple. Short sentences. Basic words.' },
  { value: '7', label: 'Ages 6–8', desc: 'Simple story. Fun details. One big lesson.' },
  { value: '10', label: 'Ages 9–12', desc: 'Richer story. Character depth. Application.' },
];
...
export default function KidsBibleStories() {
  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh', fontFamily: 'Poppins,sans-serif' }}>
      <div
        style={{
          background: 'linear-gradient(135deg,#0A1A14,#064E3B,#0F0A2E)',
      ...
      >
        ...
        <h1
          style={{
            ...
            fontWeight: 800,
            background: 'linear-gradient(90deg,#6EE7B7,#FCD34D,#F9A8D4)',
        ...
        <p style={{ color: 'rgba(255,255,255,.45)', fontSize: '.88rem', fontWeight: 500 }}>
          AI retells any Bible story for any age. Bedtime-ready. Pray together at the end.
        </p>
      </div>
      ...
      <div style={{ maxWidth: 780, margin: '0 auto', padding: '32px 20px' }}>
        ...
        >
              ...
              {AGES.map((a) => (
                <div
                  ...
                  style={{
                    padding: '14px',
                    borderRadius: 14,
                    border: `2px solid ${age === a.value ? 'var(--green)' : 'var(--border)'}`,
                    background: age === a.value ? 'var(--green-bg)' : 'var(--surface)',
                    cursor: 'pointer',
                    transition: 'all .2s',
                    textAlign: 'center',
                  }}
                >
                  <div
                    style={{
                      fontFamily: "'Baloo 2',cursive",
                      fontWeight: 800,
                      color: age === a.value ? 'var(--green)' : 'var(--ink)',
                      fontSize: '1rem',
                      marginBottom: 3,
                    }}
                  >
          ...
          <div style={{ marginBottom: 20 }}>
              ...
              {STORIES.map((s) => (
                <button
                  ...
                  style={{
                    ...
                    padding: '6px 12px',
                    borderRadius: 100,
                    border: `1.5px solid ${story === s ? 'var(--green)' : 'var(--border)'}`,
                    background: story === s ? 'var(--green-bg)' : 'var(--surface)',
                    color: story === s ? 'var(--green)' : 'var(--ink2)',
                    cursor: 'pointer',
                    transition: 'all .15s',
                  }}
                >
            ...
            <input
              ...
              placeholder='Or type any Bible story: "Ruth and Boaz", "The Tower of Babel"...'
              value={story}
        ...
        {loading && (
          <div style={{ textAlign: 'center', padding: '48px 0' }}>
            ...
            <p style={{ color: 'var(--ink2)', fontWeight: 600, marginTop: 12 }}>
        ...
        {result && !loading && (
          ...
          >
            <div
              style={{
                background: 'linear-gradient(135deg,#064E3B,#0F9D58)',
                padding: '16px 24px',
                display: 'flex',
                alignItems: 'center',
            ...
            >
              ...
              >
                {story} · {AGES.find((a) => a.value === age)?.label}
              </div>
