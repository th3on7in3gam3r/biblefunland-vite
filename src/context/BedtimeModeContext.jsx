...
export function BedtimeModeProvider({ children }) {
  ...
  const updateBedtimeSettings = (newSettings) => {
    ...
    if (userId) {
      localStorage.setItem(`bedtime_settings_${userId}`, JSON.stringify({ ...bedtimeSettings, ...newSettings }))
    }
  }
    ...
    const stories = [
      {
        ...
        content: "Daniel was a faithful man who prayed to God every day. When wicked men convinced the king to throw Daniel into a den of hungry lions, God sent an angel to protect him all night long.",
        prayer: "Dear God, thank you for protecting us like you protected Daniel. Help us to be brave and faithful always. Amen."
      },
      {
        title: "David and the Sheep",
        verse: "Psalm 23:1",
        moral: "The Lord is our shepherd who cares for us",
        content: "When David was just a young boy, he took care of his father's sheep. He learned that God is like a good shepherd who always watches over His children, just like David watched over his sheep.",
        prayer: "Thank you Lord for being our good shepherd. Help us to trust you and follow you always. Amen."
      },
      {
        title: "Baby Moses in the Basket",
        verse: "Exodus 2:10",
        moral: "God has a special plan for each of us",
        content: "When baby Moses was in danger, his mother made a special basket and placed him in the river. God guided the basket to the princess who would care for Moses and help him fulfill God's special plan.",
        prayer: "Dear God, thank you for having a special plan for each of us. Help us to trust your plan every day. Amen."
      }
    ]
  ...
  return (
    <BedtimeModeContext.Provider value={{
      bedtimeMode,
      bedtimeSettings,
      currentTime,
      isBedtime: isBedtime(),
