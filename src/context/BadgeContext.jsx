...
export const BADGE_DEFS = {
  ...
  map_pin: {
    ...
    desc: 'Discover your first location on the Living Bible Map',
    category: 'Explore',
    rarity: 'common',
  },
  map_explorer_5: {
    emoji: '🗺️',
    name: 'Bible Explorer',
    desc: 'Discover 5 locations on the Living Bible Map',
    category: 'Explore',
    rarity: 'uncommon',
  },
  map_master: {
    emoji: '🌍',
    name: 'World Traveler',
    desc: 'Discover all locations on the Living Bible Map',
    category: 'Explore',
    rarity: 'legendary',
  },
  galilean_explorer: { emoji: '🎣', name: 'Galilean Explorer', desc: 'Complete the Galilean Explorer quest', category: 'Explore', rarity: 'uncommon' },
  jesus_footsteps:   { emoji: '✝️', name: "Jesus' Footsteps",  desc: "Follow Jesus' Ministry locations",    category: 'Explore', rarity: 'rare' },
