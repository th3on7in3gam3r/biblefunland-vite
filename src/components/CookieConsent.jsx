        ...
        {!expanded && (
          <div className={styles.compact}>
            ...
            <div className={styles.compactBtns}>
              ...
              <button className={styles.btnCustomize} onClick={() => setExpanded(true)}>
                Customize
              </button>
          ...
          <div className={styles.expandedWrap}>
            ...
            <div className={styles.prefRow}>
              <div className={styles.prefInfo}>
                <div className={styles.prefName}>
                  Essential Cookies <span className={styles.required}>Always On</span>
                </div>
                <div className={styles.prefDesc}>
                  Required for login, dark mode, language, and site functionality. Cannot be
                  disabled.
                </div>
              </div>
            ...
            <div className={styles.prefRow}>
              <div className={styles.prefInfo}>
                ...
                <div className={styles.prefDesc}>
                  Google Analytics helps us understand which features are popular so we can improve
            ...
            <div className={styles.prefRow}>
              <div className={styles.prefInfo}>
                ...
                <div className={styles.prefDesc}>
                  Google AdSense uses cookies to show relevant ads. Declining means you'll still see
                  ads, but they won't be personalized to your interests.
                </div>
              </div>
              <button
            ...
            <div className={styles.expandedBtns}>
              ...
              <button className={styles.btnCustomize} onClick={acceptSelected}>
                Save My Choices
              </button>
              <button className={styles.btnAccept} onClick={acceptAll}>
                Accept All
