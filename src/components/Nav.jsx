...
export default function Nav() {
  ...
  const visibleMore = [
    churchLink,
    ...MORE_LINKS.filter(l => !(kidsMode && l.kidsHide))
  ]
      ...
      <nav className={styles.nav}>
        ...
        <div className={styles.right}>
          ...
          <button
            ...
            onMouseOver={e => { e.currentTarget.style.backgroundColor = 'rgba(159, 122, 234, 0.08)'; e.currentTarget.style.borderColor = '#9F7AEA'; e.currentTarget.style.color = '#9F7AEA' }}
            onMouseOut={e => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.borderColor = 'rgba(159, 122, 234, 0.4)'; e.currentTarget.style.color = 'var(--ink3)' }}
          >
            🌙 Bedtime Bible
          </button>
      ...
      {/* Mobile drawer */}
        ...
        {user && (
          <div className={styles.drawerSection}>
            ...
            {!kidsMode && (isPastor || userRole === 'parent' || userRole === 'teacher') && <NavLink to="/parent-hub" onClick={closeDrawer}>🏫 Parents & Teachers Hub</NavLink>}
          </div>
        )}
