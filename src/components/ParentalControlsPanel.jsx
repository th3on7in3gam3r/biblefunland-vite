    ...
    >
      ...
      {controls.parent_pin === '4318' && (
        ...
        >
          ...
          <div>
            <div style={{ fontSize: '.82rem', fontWeight: 700, color: '#F59E0B', marginBottom: 4 }}>
              Using Default PIN
            </div>
            <div
              style={{ fontSize: '.75rem', color: 'var(--ink2)', fontWeight: 500, lineHeight: 1.5 }}
            >
              You're currently using the default PIN (4318). For better security, please set a
              custom PIN below.
            </div>
          </div>
        </div>
      ...
      <div style={{ marginBottom: 20 }}>
        <div style={{ fontSize: '.82rem', fontWeight: 700, color: 'var(--ink)', marginBottom: 12 }}>
          AI Features
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {[
            {
              id: 'bible_character_chat',
              label: '💬 Bible Character Chat',
              desc: 'Chat with biblical characters',
            },
            {
              id: 'ai_prayer_companion',
              label: '🙏 AI Prayer Companion',
              desc: 'AI-powered prayer guidance',
            },
          ].map((feature) => (
            <div
              key={feature.id}
            ...
            >
              <div
                style={{
                  ...
                  background: formData.ai_toggles[feature.id] ? 'var(--blue)' : 'transparent',
                  display: 'flex',
                  alignItems: 'center',
              ...
              >
                {formData.ai_toggles[feature.id] && (
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ fontSize: '.7rem', color: 'var(--ink3)', fontWeight: 500, marginTop: 6 }}>
          Set a daily screen time limit for this child
        </div>
      </div>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ fontSize: '.7rem', color: 'var(--ink3)', fontWeight: 500, marginTop: 6 }}>
          4-digit PIN required for sensitive actions
        </div>
      </div>
        ...
        >
          <div
            style={{
              ...
              animation: pinShake ? 'shake .4s ease' : 'none',
            }}
          >
              ...
              {[0, 1, 2, 3].map((i) => (
                <div
                  ...
                  style={{
                    ...
                    height: 56,
                    borderRadius: 12,
                    border: `2.5px solid ${pinError ? 'var(--red)' : confirmPin.length > i ? 'var(--blue)' : 'var(--border)'}`,
                    background: confirmPin.length > i ? 'var(--blue-bg)' : 'var(--bg2)',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    fontSize: '1.4rem',
