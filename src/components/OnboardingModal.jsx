    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h2 style={{ fontFamily: "'Baloo 2',cursive", fontSize: '1.8rem', fontWeight: 800, color: 'var(--ink)', margin: '0 0 8px 0' }}>
        ...
        {step === 1 && (
          <div>
            <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--ink)', marginBottom: 16 }}>
              What's your role?
            </h3>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                <button key={opt.value} onClick={() => setReadingPlan(opt.value)} style={{
                  padding: 14,
                  borderRadius: 12,
