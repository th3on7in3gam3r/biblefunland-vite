    ...
    return createPortal(
      <div style={S.backdrop}>
        <div style={S.card}>
          ...
          <p style={S.desc}>
            A calm, distraction-free space for late-night devotionals and meditation. Gentle
            scripture rotation, ambient sounds, and warm amber tones.
          </p>
          <div style={S.btnRow}>
            <button
              style={S.enterBtn}
        ...
        {mode === MODES.STORY && (
          <div style={{ textAlign: 'left', padding: '0 20px' }}>
            ...
            >
              ...
              <p
                style={{ fontSize: '0.95rem', color: 'rgba(201,169,110,0.8)', fontStyle: 'italic' }}
              >
                {story.prayer}
              </p>
            </div>
