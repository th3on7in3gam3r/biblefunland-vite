...
const SEARCH_DATA = [
  ...
  { type: 'page', title: 'Join Church / Request Access', desc: 'Connect with a church or request Pastor access', icon: '🤝', to: '/church/join', tags: ['church','join','joine','pastor','request','verification','access'] },
  { type: 'page', title: 'Church Calendar', desc: 'Local services and community events', icon: '📅', to: '/community/events', tags: ['calendar','events','church','worship','services'] },
  { type: 'page', title: 'Family Fellowship', desc: 'Connect with church families and groups', icon: '👨‍👩‍👧‍👦', to: '/community/family', tags: ['family','groups','fellowship','community','kids'] },
  { type: 'page', title: 'Fellowship Chat', desc: 'Safe discussion rooms for the community', icon: '💬', to: '/community/chat', tags: ['chat','community','fellowship','discussion'] },
  { type: 'page', title: 'Daily Faith Challenge', desc: 'Daily tasks to grow your faith', icon: '🔥', to: '/challenge', tags: ['challenge','daily','faith','growth','task'] },
  { type: 'page', title: 'Activity Sheets', desc: 'Printable Bible fun for kids', icon: '📄', to: '/activity-sheets', tags: ['print','activity','sheets','kids','learning'] },
  { type: 'page', title: 'Character Chat', desc: 'AI conversations with biblical heroes', icon: '🗣️', to: '/chat/characters', tags: ['chat','ai','characters','heroes','moses','noah','david'] },
  { type: 'page', title: 'Reading Plan', desc: 'Daily schedules to read through the Word', icon: '📅', to: '/reading-plan', tags: ['plan','read','daily','schedule','bible','word'] },
  { type: 'page', title: 'Prayer Beads', desc: 'Focus your heart with digital prayer beads', icon: '📿', to: '/prayer-beads', tags: ['prayer','beads','focus','meditate','spirit'] },
  { type: 'page', title: 'Encouragement', desc: 'Uplifting messages from the community', icon: '☀️', to: '/encouragement', tags: ['encourage','support','message','wall','love'] },
  { type: 'page', title: 'Certification', desc: 'Earn your Bible studies certificate', icon: '🎓', to: '/certification', tags: ['certify','learn','study','degree','bible'] },
  { type: 'page', title: 'Bedtime Stories', desc: 'Peaceful Bible stories for sleep', icon: '🛌', to: '/bedtime', tags: ['sleep','bedtime','stories','kids','peace'] },
  { type: 'page', title: 'Original Languages', desc: 'Hebrew & Greek scripture explorer', icon: '📜', to: '/language-explorer', tags: ['hebrew','greek','languages','original','bible','study'] },
  { type: 'page', title: 'Cross Reference', desc: 'Discover scriptures related to your study', icon: '🔗', to: '/cross-reference', tags: ['cross','reference','relate','scripture','study','bible'] },
  { type: 'page', title: 'Verse Wallpaper', desc: 'Create beautiful Bible wallpapers', icon: '🖼️', to: '/wallpaper', tags: ['wallpaper','art','verse','share','background'] },
