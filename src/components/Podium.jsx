...
function PodiumCard({ entry, category, size = 80 }) {
  ...
  return (
    ...
    <div style={{
        ...
        fontFamily: "'Baloo 2', cursive", margin: '0 auto 8px',
      ...
      <div style={{
        ...
        maxWidth: size + 20, margin: '0 auto 2px',
      }}>
        {entry.displayName}
        {entry.isLegendary && ' 👑'}
      </div>
      <div style={{ fontFamily: "'Baloo 2', cursive", fontWeight: 800, fontSize: '.9rem', color: 'var(--ink2)' }}>
