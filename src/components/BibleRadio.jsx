        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
              ...
              <div>
                <div style={{ fontSize: '.8rem', fontWeight: 700, color: 'white' }}>
                  Bible Radio
                </div>
                <div style={{ fontSize: '.62rem', color: 'rgba(255,255,255,.6)', fontWeight: 500 }}>
                  {playing ? '🔴 Live' : 'Select a station'}
                </div>
              </div>
            </div>
            <button
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <button
                    ...
                    style={{
                      ...
                      alignItems: 'center',
                      justifyContent: 'center',
                      boxShadow: `0 4px 14px ${station.color}40`,
                    }}
                  >
                    {loading ? '⏳' : playing ? '⏸' : '▶'}
                  </button>
              ...
              {STATIONS.map((s, i) => (
                <button
                  ...
                  style={{
                    ...
                    padding: '9px 11px',
                    borderRadius: 11,
                    border: `1.5px solid ${station?.name === s.name ? s.color : 'var(--border)'}`,
                    background: station?.name === s.name ? s.color + '11' : 'var(--bg2)',
                    cursor: 'pointer',
                    transition: 'all .2s',
                    textAlign: 'left',
                  }}
                  ...
                  <div style={{ flex: 1 }}>
                    <div
                      style={{
                        fontSize: '.78rem',
                        fontWeight: 700,
                        color: station?.name === s.name ? s.color : 'var(--ink)',
                      }}
                    >
                      {s.name}
                    </div>
